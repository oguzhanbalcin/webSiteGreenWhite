        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          ...
          <div class="x_content">
            ...
            <form action="../netting/islem.php" method="POST" enctype="multipart/form-data"data-parsley-validate class="form-horizontal form-label-left">
              ...
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Slider resimyol <span class="required">*</span>
              </label>
             ...
             <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" id="first-name" required="required" name="slider_ad" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
            <div class="form-group">
